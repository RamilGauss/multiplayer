...
TLoaderModelDXTest::TLoaderModelDXTest(  IDirect3DDevice9* _m_pd3dDevice):
...
//--------------------------------------------------------------------------------
bool TLoaderModelDXTest::LoadMainFile()
{
  mFileIniMain.Close();
...
//--------------------------------------------------------------------------------
bool TLoaderModelDXTest::LoadFileResource()
{
  mFileIniRes.Close();
...
//--------------------------------------------------------------------------------
bool TLoaderModelDXTest::LoadPart(int i)
{
  char strNumPart[20];
...
//--------------------------------------------------------------------------------
bool TLoaderModelDXTest::LoadVector(char* strNumPart,char* key,D3DXVECTOR3& vector)
{
...
//--------------------------------------------------------------------------------
char* TLoaderModelDXTest::FindSemicolon(char* buffer)
{
  for(int i = 0 ; true ; i++ )
  {
...
//--------------------------------------------------------------------------------
float TLoaderModelDXTest::FindFloat_Semicolon(char** buffer,bool* ok)
{
  char cpyBuffer[50];
  char* buffer1;
  char* buffer0 = *buffer;
...
//--------------------------------------------------------------------------------
bool TLoaderModelDXTest::LoadMesh(char* strNumPart,TDefGroup *mArrDefGroup)
{
  HRESULT hr;
...
//--------------------------------------------------------------------------------
int TLoaderModelDXTest::FindInt_Semicolon(char** buffer,bool* ok)
{
  char cpyBuffer[50];
  char* buffer1;
  char* buffer0 = *buffer;
