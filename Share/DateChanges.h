...
05.07.2012:
 ...
 - Косервация проекта с веткой на основе DXUT. Развитие ветки Qt+DX.
...
57) Анимация гусеницы(трака) Google.
58) Глюк: если мышкой кликнуть на заголовке окна и не отпускать, то событие WM_DXUT_STOP не 
обработается. Не критично пока.
...
60) Менеджер управления временем жизни моделей - 
61) что отображать в визуализаторе во время загрузки - 
62) Qt + DirectX ??? идея интересная, http://habrahabr.ru/post/62051/
63) 
//----------------------------------------------------------------------------------------------------------------
//----------------------------------------------------------------------------------------------------------------
    INFO
