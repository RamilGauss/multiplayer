...
50) Данные в комнату подводятся. Осталось обработать запросы из вне в TRoom - 
51) Стрим и данные от клиента не отсылаются (хотя бы стрим) -
52) Корректирующий пакет от комнаты -
53) Совсем забыл как работать с std::list, поставь эксперимент дома в main.cpp см. TRoom::AnalizPacket() -
