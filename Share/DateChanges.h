...
26.10.2013:
  Идея поместить в ScenarioLoginClient 4 части: Client, Slave, Master и SuperServer,
	...
	тезкам. Есть базовый класс, от которого наследуются эти классы, в нем должны быть опредеоены
	все пакеты, а базовый пакет должен быть в ScenarioLoginClient, в нем появлеятся поле
