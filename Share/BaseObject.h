...
protected:
  ...
  D3DXMATRIXA16 mWorld; // здесь вс€ инфа по ориентации и координатам объекта
  ...
  void* mPtrInherits;// назначить в TBaseObjectCommon (решение проблемы виртуального наследовани€)
