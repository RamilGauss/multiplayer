...
class TGraphicEngineGUI_Private
{
  ...
  CDXUTDialog
#endif
  mPrivateDialog;// хранит указатели на приватные объекты классов IControl, IButton, etc.
...
private:
  ...
  TMapPtrPtr     mMapPrivatePublicGUI;// для поиска по указателю, в public находится указатель на private
