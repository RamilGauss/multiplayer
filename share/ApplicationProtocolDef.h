...
#define APPL_TYPE_A_END_FIGHT             (APPL_TYPE_BASE_ANSWER+6) // конец битвы, пока не знаю что передавать (результат боя, КЭП)
...
#define APPL_TYPE_S_LOAD_MAP            (APPL_TYPE_BASE_STREAM+2)// во время завгрузки карты на сервере
