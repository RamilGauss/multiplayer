...
#ifndef MELISSA_BASE_SC_LOGIN_CLIENT_STRUCT_H
#define MELISSA_BASE_SC_LOGIN_CLIENT_STRUCT_H
...
#pragma pack(push, 1)
    ...
    //-------------------------------------------------
	  ...
	  //-------------------------------------------------
    struct THeaderCheckInfoClientM2S : public THeaderM
    {
      THeaderCheckInfoClientM2S();
    };
	  //-------------------------------------------------
